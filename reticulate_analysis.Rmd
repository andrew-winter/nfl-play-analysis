...
"complete_pass", "incomplete_pass", "pass_length",
"receiver", "receiving_yards",
"pass_attempt", "passer", "passing_yards", "pass",
"rush_attempt", "rusher", "rushing_yards", "rush",
...
"""
  dplyr::select(
    time, play_type, down, play_id, drive, qtr,
    yrdln, yardline_100, yards_gained, ydstogo,
    posteam, defteam,
    passer, complete_pass, pass_attempt, passing_yards,
    receiver, receiving_yards,
    rusher, rush_attempt, rushing_yards,

    desc, penalty, penalty_team,
    season_type, game_id, game_date, season) |> 
"""
```
